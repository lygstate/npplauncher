...
#define NPPL_PLGN_HELP_TEXT TEXT("NppLauncher Plugin\n\
Copyright: Mattes H.\n\
...
#define NPPL_PRG_HELP TEXT("NppLauncher\n\
Copyright: Mattes H.\n\
This program replaces the notepad.exe by a different editor like Notepad++\n\
It creates a blocking application in the systemtray and sends request \n\
